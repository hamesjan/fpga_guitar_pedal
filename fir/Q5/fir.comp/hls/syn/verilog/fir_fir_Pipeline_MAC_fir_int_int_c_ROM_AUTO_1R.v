...
initial begin
    ...
    $readmemh("./fir_fir_Pipeline_MAC_fir_int_int_c_ROM_AUTO_1R.dat", rom1); 
    $readmemh("./fir_fir_Pipeline_MAC_fir_int_int_c_ROM_AUTO_1R.dat", rom2); 
    $readmemh("./fir_fir_Pipeline_MAC_fir_int_int_c_ROM_AUTO_1R.dat", rom3); 
    $readmemh("./fir_fir_Pipeline_MAC_fir_int_int_c_ROM_AUTO_1R.dat", rom4); 
    $readmemh("./fir_fir_Pipeline_MAC_fir_int_int_c_ROM_AUTO_1R.dat", rom5); 
    $readmemh("./fir_fir_Pipeline_MAC_fir_int_int_c_ROM_AUTO_1R.dat", rom6); 
    $readmemh("./fir_fir_Pipeline_MAC_fir_int_int_c_ROM_AUTO_1R.dat", rom7); 
    $readmemh("./fir_fir_Pipeline_MAC_fir_int_int_c_ROM_AUTO_1R.dat", rom8); 
    $readmemh("./fir_fir_Pipeline_MAC_fir_int_int_c_ROM_AUTO_1R.dat", rom9);
end
