...
// ==============================================================
`timescale 1 ns / 1 ps
module fir_fir_Pipeline_MAC_fir_int_int_c_8_ROM_AUTO_1R (
    address0, ce0, q0, 
    address1, ce1, q1, 
    address2, ce2, q2, 
    address3, ce3, q3, 
...
initial begin
    ...
    $readmemh("./fir_fir_Pipeline_MAC_fir_int_int_c_8_ROM_AUTO_1R.dat", rom0); 
    $readmemh("./fir_fir_Pipeline_MAC_fir_int_int_c_8_ROM_AUTO_1R.dat", rom1); 
    $readmemh("./fir_fir_Pipeline_MAC_fir_int_int_c_8_ROM_AUTO_1R.dat", rom2); 
    $readmemh("./fir_fir_Pipeline_MAC_fir_int_int_c_8_ROM_AUTO_1R.dat", rom3); 
    $readmemh("./fir_fir_Pipeline_MAC_fir_int_int_c_8_ROM_AUTO_1R.dat", rom4); 
    $readmemh("./fir_fir_Pipeline_MAC_fir_int_int_c_8_ROM_AUTO_1R.dat", rom5); 
    $readmemh("./fir_fir_Pipeline_MAC_fir_int_int_c_8_ROM_AUTO_1R.dat", rom6); 
    $readmemh("./fir_fir_Pipeline_MAC_fir_int_int_c_8_ROM_AUTO_1R.dat", rom7); 
    $readmemh("./fir_fir_Pipeline_MAC_fir_int_int_c_8_ROM_AUTO_1R.dat", rom8); 
    $readmemh("./fir_fir_Pipeline_MAC_fir_int_int_c_8_ROM_AUTO_1R.dat", rom9);
end
