...
(* CORE_GENERATION_INFO="trace_cntrl_32_trace_cntrl_32,hls_ip_2024_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=6.600000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=360,HLS_SYN_LUT=625,HLS_VERSION=2024_1}" *)
...
wire   [31:0] trigger;
wire   [31:0] length_r;
reg   [31:0] length_r_read_reg_127;
reg   [31:0] trigger_read_reg_133;
wire   [31:0] sub_fu_121_p2;
reg   [31:0] sub_reg_138;
wire    ap_CS_fsm_state2;
wire    grp_trace_cntrl_32_Pipeline_VITIS_LOOP_28_1_fu_86_ap_start;
wire    grp_trace_cntrl_32_Pipeline_VITIS_LOOP_28_1_fu_86_ap_done;
wire    grp_trace_cntrl_32_Pipeline_VITIS_LOOP_28_1_fu_86_ap_idle;
wire    grp_trace_cntrl_32_Pipeline_VITIS_LOOP_28_1_fu_86_ap_ready;
wire   [31:0] grp_trace_cntrl_32_Pipeline_VITIS_LOOP_28_1_fu_86_capture_32_TDATA;
wire    grp_trace_cntrl_32_Pipeline_VITIS_LOOP_28_1_fu_86_capture_32_TVALID;
wire    grp_trace_cntrl_32_Pipeline_VITIS_LOOP_28_1_fu_86_capture_32_TREADY;
...
wire   [0:0] grp_trace_cntrl_32_Pipeline_VITIS_LOOP_28_1_fu_86_capture_32_TUSER;
wire   [0:0] grp_trace_cntrl_32_Pipeline_VITIS_LOOP_28_1_fu_86_capture_32_TLAST;
wire   [0:0] grp_trace_cntrl_32_Pipeline_VITIS_LOOP_28_1_fu_86_capture_32_TID;
wire   [0:0] grp_trace_cntrl_32_Pipeline_VITIS_LOOP_28_1_fu_86_capture_32_TDEST;
wire    grp_trace_cntrl_32_Pipeline_VITIS_LOOP_28_1_fu_86_trace_32_TREADY;
reg    grp_trace_cntrl_32_Pipeline_VITIS_LOOP_28_1_fu_86_ap_start_reg;
...
initial begin
#0 ap_CS_fsm = 4'd1;
#0 grp_trace_cntrl_32_Pipeline_VITIS_LOOP_28_1_fu_86_ap_start_reg = 1'b0;
end

trace_cntrl_32_trace_cntrl_32_Pipeline_VITIS_LOOP_28_1 grp_trace_cntrl_32_Pipeline_VITIS_LOOP_28_1_fu_86(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        grp_trace_cntrl_32_Pipeline_VITIS_LOOP_28_1_fu_86_ap_start_reg <= 1'b0;
    end else begin
        if ((1'b1 == ap_CS_fsm_state2)) begin
            grp_trace_cntrl_32_Pipeline_VITIS_LOOP_28_1_fu_86_ap_start_reg <= 1'b1;
        end else if ((grp_trace_cntrl_32_Pipeline_VITIS_LOOP_28_1_fu_86_ap_ready == 1'b1)) begin
            grp_trace_cntrl_32_Pipeline_VITIS_LOOP_28_1_fu_86_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state1)) begin
        ...
        trigger_read_reg_133 <= trigger;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        sub_reg_138 <= sub_fu_121_p2;
    end
end
...
always @ (*) begin
    if ((grp_trace_cntrl_32_Pipeline_VITIS_LOOP_28_1_fu_86_ap_done == 1'b0)) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state3 : begin
            if (((grp_trace_cntrl_32_Pipeline_VITIS_LOOP_28_1_fu_86_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state3))) begin
...
assign capture_32_TVALID_int_regslice = grp_trace_cntrl_32_Pipeline_VITIS_LOOP_28_1_fu_86_capture_32_TVALID;

assign grp_trace_cntrl_32_Pipeline_VITIS_LOOP_28_1_fu_86_ap_start = grp_trace_cntrl_32_Pipeline_VITIS_LOOP_28_1_fu_86_ap_start_reg;

assign grp_trace_cntrl_32_Pipeline_VITIS_LOOP_28_1_fu_86_capture_32_TREADY = (capture_32_TREADY_int_regslice & ap_CS_fsm_state3);

assign sub_fu_121_p2 = ($signed(length_r_read_reg_127) + $signed(32'd4294967295));
