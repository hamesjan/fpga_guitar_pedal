...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue_int == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if ((~((stream_out_32_TREADY == 1'b0) | (1'b1 == ap_block_state1_pp0_stage0_iter0)) & (ap_loop_exit_ready == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (*) begin
    if (((stream_out_32_TREADY == 1'b0) | (1'b1 == ap_block_state1_pp0_stage0_iter0))) begin
...
always @ (*) begin
    if ((~((stream_out_32_TREADY == 1'b0) | (1'b1 == ap_block_state1_pp0_stage0_iter0)) & (in_pixel_last_fu_110_p1 == 1'd1) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if ((~((stream_out_32_TREADY == 1'b0) | (1'b1 == ap_block_state1_pp0_stage0_iter0)) & (ap_loop_exit_ready == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
        ap_done_int = 1'b1;
    end else begin
...
always @ (*) begin
    if ((~((stream_out_32_TREADY == 1'b0) | (1'b1 == ap_block_state1_pp0_stage0_iter0)) & (1'b1 == ap_CS_fsm_state1))) begin
        ap_ready_int = 1'b1;
    end else begin
        ap_ready_int = 1'b0;
    end
