...
wire   [0:0] ap_phi_reg_pp0_iter0_last_2_31173_reg_216;
wire   [31:0] out_pixel_data_fu_372_p1;
reg    ap_block_pp0_stage3_01001;
reg    ap_block_pp0_stage0_01001;
reg    ap_block_pp0_stage1_01001;
wire   [0:0] out_pixel_user_fu_377_p1;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_291)) begin
        if (((last_8_reg_148 == 1'd0) & (delayed_last_reg_137 == 1'd0))) begin
            last_2_31173_reg_216 <= ap_phi_mux_last_2_3_ph_phi_fu_203_p8;
        end else if ((1'b1 == 1'b1)) begin
            last_2_31173_reg_216 <= ap_phi_reg_pp0_iter0_last_2_31173_reg_216;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_pp0_stage0)) begin
        if (((1'b0 == ap_block_pp0_stage0_subdone) & (ap_loop_init == 1'b1))) begin
            ...
            last_8_reg_148 <= last_2_31173_reg_216;
        end
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_pp0_stage0)) begin
        if ((ap_loop_init == 1'b1)) begin
            ...
            ap_phi_mux_delayed_last_phi_fu_140_p4 = delayed_last_reg_137;
        end
    end else begin
        ap_phi_mux_delayed_last_phi_fu_140_p4 = delayed_last_reg_137;
    end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_pp0_stage0)) begin
        if ((ap_loop_init == 1'b1)) begin
            ...
            ap_phi_mux_last_8_phi_fu_152_p4 = last_2_31173_reg_216;
        end else begin
            ap_phi_mux_last_8_phi_fu_152_p4 = 1'd0;
        end
    end else begin
...
always @ (*) begin
    if (((ap_predicate_op80_write_state6 == 1'b1) & (1'b0 == ap_block_pp0_stage1_01001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        ...
        stream_out_32_TDATA = out_pixel_data_fu_372_p1;
    end else begin
...
always @ (*) begin
    if (((ap_predicate_op80_write_state6 == 1'b1) & (1'b0 == ap_block_pp0_stage1_01001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        ...
        stream_out_32_TUSER = out_pixel_user_fu_377_p1;
    end else begin
...
always @ (*) begin
    ap_condition_530 = ((1'b0 == ap_block_pp0_stage0) & (delayed_last_reg_137 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_condition_535 = ((1'b0 == ap_block_pp0_stage2_11001) & (last_8_reg_148 == 1'd0) & (delayed_last_reg_137 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2));
end

always @ (*) begin
    ap_condition_538 = ((in_pixel_last_4_reg_472 == 1'd0) & (in_pixel_last_reg_455 == 1'd0) & (grp_fu_238_p1 == 1'd1));
end

always @ (*) begin
    ap_condition_544 = ((1'b0 == ap_block_pp0_stage0_11001) & (delayed_last_reg_137 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end
...
assign ap_phi_reg_pp0_iter0_last_2_31173_reg_216 = 1'd1;
...
assign out_pixel_data_fu_372_p1 = ap_phi_mux_buffer_1_3_ph_phi_fu_163_p8[31:0];

assign out_pixel_user_fu_377_p1 = ap_phi_mux_has_user_1_3_ph_phi_fu_189_p8[0:0];
