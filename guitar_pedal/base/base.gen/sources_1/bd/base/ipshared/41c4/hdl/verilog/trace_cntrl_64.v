...
(* CORE_GENERATION_INFO="trace_cntrl_64_trace_cntrl_64,hls_ip_2024_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=6.600000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=432,HLS_SYN_LUT=689,HLS_VERSION=2024_1}" *)
...
wire   [63:0] trigger;
wire   [31:0] length_r;
reg   [31:0] length_r_read_reg_133;
wire   [31:0] empty_fu_123_p1;
reg   [31:0] empty_reg_139;
wire   [31:0] sub_fu_127_p2;
reg   [31:0] sub_reg_144;
wire    ap_CS_fsm_state2;
wire    grp_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1_fu_88_ap_start;
wire    grp_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1_fu_88_ap_done;
wire    grp_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1_fu_88_ap_idle;
wire    grp_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1_fu_88_ap_ready;
wire   [63:0] grp_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1_fu_88_capture_64_TDATA;
wire    grp_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1_fu_88_capture_64_TVALID;
wire    grp_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1_fu_88_capture_64_TREADY;
...
wire   [0:0] grp_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1_fu_88_capture_64_TUSER;
wire   [0:0] grp_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1_fu_88_capture_64_TLAST;
wire   [0:0] grp_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1_fu_88_capture_64_TID;
wire   [0:0] grp_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1_fu_88_capture_64_TDEST;
wire    grp_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1_fu_88_trace_64_TREADY;
reg    grp_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1_fu_88_ap_start_reg;
...
initial begin
#0 ap_CS_fsm = 4'd1;
#0 grp_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1_fu_88_ap_start_reg = 1'b0;
end

trace_cntrl_64_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1 grp_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1_fu_88(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        grp_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1_fu_88_ap_start_reg <= 1'b0;
    end else begin
        if ((1'b1 == ap_CS_fsm_state2)) begin
            grp_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1_fu_88_ap_start_reg <= 1'b1;
        end else if ((grp_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1_fu_88_ap_ready == 1'b1)) begin
            grp_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1_fu_88_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (*) begin
    if ((grp_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1_fu_88_ap_done == 1'b0)) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state3 : begin
            if (((grp_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1_fu_88_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state3))) begin
...
assign capture_64_TVALID_int_regslice = grp_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1_fu_88_capture_64_TVALID;

assign empty_fu_123_p1 = trigger[31:0];

assign grp_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1_fu_88_ap_start = grp_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1_fu_88_ap_start_reg;

assign grp_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1_fu_88_capture_64_TREADY = (capture_64_TREADY_int_regslice & ap_CS_fsm_state3);

assign sub_fu_127_p2 = ($signed(length_r_read_reg_133) + $signed(32'd4294967295));
