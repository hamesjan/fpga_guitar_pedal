set SynModuleInfo {
  {SRCNAME audio MODELNAME audio RTLNAME audio IS_TOP 1
    SUBMODULES {
      {MODELNAME audio_mul_32ns_32s_64_2_1 RTLNAME audio_mul_32ns_32s_64_2_1 BINDTYPE op TYPE mul IMPL auto LATENCY 1 ALLOW_PRAGMA 1}
      {MODELNAME audio_mul_32s_32ns_64_2_1 RTLNAME audio_mul_32s_32ns_64_2_1 BINDTYPE op TYPE mul IMPL auto LATENCY 1 ALLOW_PRAGMA 1}
